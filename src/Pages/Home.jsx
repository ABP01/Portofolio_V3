...
const TECH_STACK = ["NextJs", "Javascript", "Node.js", "Tailwind", "Flutter", "React", "Python", "Java", "Typescript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ABP01" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/armel-komla-bogue/" },
  { icon: Instagram, link: "https://www.instagram.com/armelbogue2" }
];
